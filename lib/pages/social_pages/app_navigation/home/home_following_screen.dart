...
import '../../provider/ViewModel/edit_post_viewmodel.dart';
...
{
  var iconSize = Dimens.feedIconSize;
  var feedReactionCountSize = Dimens.feedReactionCountSize;
                ...
                children: [
                  ListTile(
                    ...
                    subtitle: Text(
                      ...
                      style: widget().theme.textTheme.bodyText1!.copyWith(
                          color: AppColors.amity_textGrey, fontSize: 13),
                    ),
                    trailing: Row(
